...
class CombatState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CombatState', createEmptyInstance: create)
    ...
    ..a<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'playerCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.int get playerCount => $_getIZ(3);
  @$pb.TagNumber(4)
  set playerCount($core.int v) { $_setSignedInt32(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasPlayerCount() => $_has(3);
  @$pb.TagNumber(4)
  void clearPlayerCount() => clearField(4);
}

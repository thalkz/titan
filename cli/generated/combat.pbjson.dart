...
const CombatState$json = const {
  ...
  '2': const [
    ...
    const {'1': 'player_id', '3': 3, '4': 3, '5': 9, '10': 'playerId'},
  ],
};

/// Descriptor for `CombatState`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List combatStateDescriptor = $convert.base64Decode('CgtDb21iYXRTdGF0ZRIZCgh0aXRhbl9pZBgBIAEoCVIHdGl0YW5JZBIZCgh0aXRhbl9ocBgCIAEoBVIHdGl0YW5IcBIbCglwbGF5ZXJfaWQYAyADKAlSCHBsYXllcklk');
